...
new_cases <- read_excel(path = "final_data/Raw_data/new_covid_cases.xlsx") 

# Next I loaded vaccinated data, by date. 
total_vac <- read_excel(path = "final_data/Raw_data/number_vaccinated.xlsx") 
...
vax_by_city_age <- read_excel(path = "final_data/Raw_data/total_bycity.xls") 
perc_vax_city <- read_excel(path = "final_data/raw_data/perc_city.xlsx")
city_econ <- read_excel(path = "final_data/raw_data/econ_status_city.xlsx")
...
econ_status_plot <- vax_econ_clean %>% 
...
data_map %>% 
  write_csv("covid_vaccination_and_socioeconomic_status/final_data/data_map.csv")
